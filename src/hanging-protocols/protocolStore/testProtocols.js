...
function getMRTwoByTwoTest() {
    ...
    const oneByTwo = new ViewportStructure('grid', {
        Rows: 1,
        Columns: 2
    });

    // Stage 1
    const left = new Viewport();
    const right = new Viewport();

    const firstSeries = new SeriesMatchingRule('SeriesNumber', {
        equals: {
            value: 1
        }
    });

    const secondSeries = new SeriesMatchingRule('SeriesNumber', {
        equals: {
            value: 2
        }
    });

    const thirdImage = new ImageMatchingRule('InstanceNumber', {
        equals: {
            value: 3
        }
    });
    ...
    const first = new Stage(oneByTwo, 'oneByTwo');
    ...
    // Stage 2
    const twoByOne = new ViewportStructure('grid', {
        Rows: 2,
        Columns: 1
    });
    const left2 = new Viewport();
    const right2 = new Viewport();

    const fourthSeries = new SeriesMatchingRule('SeriesNumber', {
        equals: {
            value: 4
        }
    });

    const fifthSeries = new SeriesMatchingRule('SeriesNumber', {
        equals: {
            value: 5
        }
    });
    ...
    const second = new Stage(twoByOne, 'twoByOne');
